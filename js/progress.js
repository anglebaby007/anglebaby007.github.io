...
(function(){
    ...
    var START_COLOR = '#f22eff',//渐变背景颜色的起始颜色
        END_COLOR = '#f22e00';//终点颜色

    var progressBar = document.createElement('div');//创建页面进度条
    //进度条的样式设置
    progressBar.style.cssText += ';position:fixed;top:0;left:0;height:3px;background:linear-gradient(to right, '+START_COLOR+', '+END_COLOR+');z-index:10002;';
